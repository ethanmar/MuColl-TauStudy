...
read.Files = [f"{the_args.InFileName}.slcio"]
algList.append(read)
...
if not the_args.enableBIB:
    Output_REC.Parameters = {
        ...
        "LCIOOutputFile": [f"{the_args.OutFileName}.slcio"],
    ...
    Output_REC.Parameters = {
        ...
        "DropCollectionNames": [
            ...
            "EcalBarrelRelationsSimDigi", "EcalBarrelRelationsSimRec", "EcalBarrelRelationsSimConed", "EcalBarrelRelationsSimSel", 
            "EcalEndcapRelationsSimDigi", "EcalEndcapRelationsSimRec", "EcalEndcapRelationsSimConed", "EcalEndcapRelationsSimSel",  
            "HcalBarrelRelationsSimDigi", "HcalBarrelRelationsSimRec", "HcalBarrelRelationsSimConed", "HcalBarrelRelationsSimSel",  
            "HcalEndcapRelationsSimDigi", "HcalEndcapRelationsSimRec", "HcalEndcapRelationsSimConed", "HcalEndcapRelationsSimSel"
        ],
        "FullSubsetCollections": [
...
InitDD4hep.Parameters = {
    "DD4hepXMLFile": [os.environ["MAIA_GEO"]],
...
MyEcalBarrelSelector.Parameters = {
    ...
    "ThresholdsFilePath": [the_args.ThresholdsPath + "/data/ECAL_Thresholds_10TeV.root"],
    "Nsigma": ["0"],
    "TimeWindowMin": ["-0.3"],
    "TimeWindowMax": ["0.3"],
...
MyHcalBarrelSelector.Parameters = {
    ...
    "ThresholdsFilePath": [the_args.ThresholdsPath + "/data/HCAL_Thresholds_10TeV.root"],
    "FlatThreshold": ["5e-05"],
    "Nsigma": ["0"],
    "TimeWindowMin": ["-0.3"],
    "TimeWindowMax": ["0.3"],
