#ifndef MyEvaluateTauTauMuMu_h
#define MyEvaluateTauTauMuMu_h 1
...
class MyEvaluateTauTauMuMu : public Processor {

public:
  virtual Processor *newProcessor() { return new MyEvaluateTauTauMuMu; }

  MyEvaluateTauTauMuMu();
  MyEvaluateTauTauMuMu(const MyEvaluateTauTauMuMu &) = delete;
  MyEvaluateTauTauMuMu &operator=(const MyEvaluateTauTauMuMu &) = delete;
...
protected:
  ...
  float recE[NTAU_MAX], recPx[NTAU_MAX], recPy[NTAU_MAX], recPz[NTAU_MAX],
      ...
      recSigmaD0[NTAU_MAX], recZ0[NTAU_MAX], recESeed[NTAU_MAX],
      recMInv[NTAU_MAX];
  int recNPfos[NTAU_MAX], recNQTracks[NTAU_MAX], charge[NTAU_MAX],
      mcDecayMode[NTAU_MAX];
  int matched[NTAU_MAX], missed[NTAU_MAX], fake[NTAU_MAX], decayMu[NTAU_MAX],
      decayEl[NTAU_MAX];
  int pfosPdg[NTAU_MAX][20];
  float pfosDeltaR[NTAU_MAX][20], pfosPt[NTAU_MAX][20], pfosPx[NTAU_MAX][20],
      pfosPy[NTAU_MAX][20], pfosPz[NTAU_MAX][20];
