#include "MyTauFinder/MyPrepareRECParticles.h"
...
MyPrepareRECParticles aMyPrepareRECParticles ;
...
MyPrepareRECParticles::MyPrepareRECParticles() : Processor("MyPrepareRECParticles") 
{
  // modify processor description
  _description = "MyPrepareRECParticles converts input to ReconstructedParticles and puts them into a new collection making sure all the information which is needed to run the TauFinder is provided. ";
...
void MyPrepareRECParticles::init() 
{ 
...
void MyPrepareRECParticles::processRunHeader( LCRunHeader* )
{ 
  _nRun++ ;
} 

void MyPrepareRECParticles::processEvent( LCEvent * evt ) 
{ 
...
void MyPrepareRECParticles::check( LCEvent* ) {
  // nothing to check here - could be used to fill checkplots in reconstruction processor
}


void MyPrepareRECParticles::end(){ 
  
  
  streamlog_out( DEBUG ) << "MyPrepareRECParticles::end()  " << name()
