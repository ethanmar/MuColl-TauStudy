...
parser.add_argument(
    ...
    type=str,
    default=os.environ.get("ACTS_MatFile", ""),
)
...
parser.add_argument(
    ...
    type=str,
    default=os.environ.get("ACTS_TGeoFile", ""),
)

parser.add_argument(
    "--TGeoDescFile",
    help="TGeometry description file",
    type=str,
    default=os.environ.get("ACTS_TGeoDescFile", ""),
)
...
LCIOWriter = MarlinProcessorWrapper("LCIOWriter")
LCIOWriter.OutputLevel = INFO
LCIOWriter.ProcessorType = "LCIOOutputProcessor"
LCIOWriter.Parameters = {
    "DropCollectionTypes": [],
    "DropCollectionNames": [],
    "FullSubsetCollections": [],
    "KeepCollectionNames": [],
    "LCIOOutputFile": ["reco_output.slcio"],
...
InitDD4hep.Parameters = {
    "DD4hepXMLFile": [args.DD4hepXMLFile],
...
DDMarlinPandora.Parameters = {
    ...
    "ECalCaloHitCollections": ["EcalBarrelCollectionConed", "EcalEndcapCollectionConed"],
...
#    "MuonEndCapBField": ["5.0"],
    ...
    "RelCaloHitCollections": ["EcalBarrelRelationsSimConed", "EcalEndcapRelationsSimConed", "HcalBarrelRelationsSimConed", "HcalEndcapRelationsSimConed", "RelationMuonHit"],
